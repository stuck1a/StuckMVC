...
/**
 * Controller for content page "Home". Also works as initial and default content page.
 * @package StuckMVC
 */
class HomeController extends \Stuck1A\StuckMVC\Core\Controller\PageController {
  /**
   * Identifier of the content page for which this page controller is responsible.
   * Covers additional special case for common requests to the website root.
   *
   * @var array
   */
  protected static $mapping = [ 'home', '', 'index' ];
