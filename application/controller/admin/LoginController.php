...
/**
 * Renders the backend login page
 * @package StuckMVC
 */
class LoginController extends \Stuck1a\StuckMVC\Core\Controller\BackendController {
  /**
   * Identifier of the backend section for which this backend controller is responsible
   *
   * @var array
   */
  protected static $mapping = [ 'login' ];
