...
class LoginWidget extends \Stuck1A\StuckMVC\Core\Controller\WidgetController {
  /**
   * Widgets main template file, which will returned to the renderer on call
   * @var string
   */
  private const template = 'views/login.tpl';
  
  /**
   * Internal name of the widget. Used as name for the accessor variable in templates.
   * @var string
   */
  ...
  public function __construct() {
    $this->name = \Stuck1A\StuckMVC\Core\Base::base_name(dirname(__FILE__));
    parent::__construct();
  }
