...
/**
 * Will be thrown if a unspecific error occurred while routing a request.
 */
class RoutingException extends GenericException {
  /**
   * RoutingException constructor.
   * @param string $message message of the exception
   */
  function __construct($message = "RoutingException") {
