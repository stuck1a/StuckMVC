...
/**
 * Will be thrown if the framework tries to dispatch an model, which class file can't be found.
 */
class ModelNotFoundException extends GenericException {
  /**
   * ModelNotFoundException constructor.
   * @param string $message message of the exception
   */
  function __construct($message = "Unable to invoke requested model!") {
