...
/**
 * Will be thrown if a required framework file is not found.
 */
class MissingCoreFileException extends GenericException {
  /**
   * MissingCoreFileException constructor.
   * @param string $message message of the exception
   */
  function __construct($message = "MissingCoreFileException") {
